...
public class NewOpportunitiesSalesforce extends BaseClassSf {
	...
	public String[][] newOppo() throws IOException {
		String[][] data = ReadNewOpportunity.readData();
		return data;
	...
	public void newOpportunity(String oppname) throws InterruptedException {
		// TODO Auto-generated method stub
		 ...
		 String oppoNameVerify = driver.findElement(By.xpath("//a[@class = 'forceActionLink']/div")).getText();
//		 String oppoName = "\"Salesforce Automation by Rahul\"";
		 
		 if(oppoNameVerify.equalsIgnoreCase(textOppo))
		 {
