...
public class CreateContactSalesforce {
...
//		 17.verify message
		 String verify = driver.findElement(By.xpath("//div[@class = 'forceVisualMessageQueue']")).getText();
		 System.out.println(verify);
		 
		 String textVerify = "Account \"Rahul Krish\" was created.";
